...
aapt package -v -M AndroidManifest.xml -S res --min-sdk-version 29 --target-sdk-version 29 -I $ANDROID_SDK_ROOT/platforms/android29/android.jar -F ${APK_NAME}-unaligned.apk
